...
<p align="center">
  <img src=".github/assets/shimmerKit.gif" width="200" alt="ShimmerKit Demo">
</p>
...
2. Enter package URL: `https://github.com/kaizzalainangeles/ShimmerKit`
3. Click Add Package
...
```swift
dependencies: [
    .package(url: "https://github.com/kaizzalainangeles/ShimmerKit", from: "1.0.0")
]
```
